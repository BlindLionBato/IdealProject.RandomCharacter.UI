...
output "codestar_connections_read_access_policy" {
  value = {
    arn = aws_iam_policy.codestar_connections_read_access.arn
  }
}

output "codestar_connections_execute_access_policy" {
  value = {
    arn = aws_iam_policy.codestar_connections_execute_access.arn
  }
}