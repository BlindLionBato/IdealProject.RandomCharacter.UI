...
output "s3_read_access_policy" {
  value = {
    arn = aws_iam_policy.s3_read_access.arn
    name = aws_iam_policy.s3_read_access.name
  }
}

output "s3_full_access_policy" {
  value = {
    arn = aws_iam_policy.s3_full_access.arn
    name = aws_iam_policy.s3_full_access.name
  }
}